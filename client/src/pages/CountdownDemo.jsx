    ...
    <div className="min-h-screen pt-24 px-6 pb-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          <div className="bg-white/10 backdrop-blur-md rounded-xl p-6 border border-pink-800 text-center">
            <div className="text-4xl mb-4">⏰</div>
            <h3 className="text-xl font-semibold text-pink-900 mb-2">
              Real-time Countdown
            </h3>
            <p className="text-gray-900">
              Watch the seconds tick down to your departure with beautiful
              animations
            </p>
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-xl p-6 border border-pink-800 text-center">
            ...
            <p className="text-gray-900">
              Get personalized tips based on destination, time until trip, and
              your interests
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          <div className="bg-white/10 backdrop-blur-md rounded-xl p-6 border border-pink-800">
            <h3 className="text-2xl font-semibold text-pink-900 mb-4">
              🎨 Customizable Themes
            </h3>
            <p className="text-gray-900 mb-4">
              Choose from multiple beautiful themes including Ocean, Sunset,
              Forest, and Midnight. Personalize your countdown experience to
              match your style.
            </p>
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-xl p-6 border border-pink-800">
            ...
            <p className="text-gray-800 mb-4">
              Never miss important trip milestones with customizable
        ...
        {/* Technical Features */}
        <div className="bg-white/10 backdrop-blur-md rounded-xl p-8 border border-pink-800">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="text-center">
              <div className="text-3xl mb-2">🎭</div>
              <h4 className="font-semibold text-black mb-2">Framer Motion</h4>
              <p className="text-sm text-gray-900">
