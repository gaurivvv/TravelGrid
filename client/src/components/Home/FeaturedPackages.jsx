          ...
          {loading
            ...
            : packages.map((pkg, i) => (
                <motion.div
                  ...
                  initial="hidden"
                  whileInView="visible"
                  className={`group relative backdrop-blur-md rounded-2xl overflow-hidden border transition-all duration-500 hover:scale-105 hover:shadow-2xl hover:shadow-pink-500/20 h-full ${
                    isDarkMode
