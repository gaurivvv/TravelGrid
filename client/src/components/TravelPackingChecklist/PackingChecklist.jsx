...
const PackingChecklist = () => {
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-black to-pink-900">
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="bg-gray-600 rounded-full h-2">
                        <div
                          className={`h-2 rounded-full transition-all duration-300 ${isSelected ? 'bg-white' : 'bg-blue-500'
                            }`}
              ...
              <div className="bg-gray-800 rounded-lg p-6 border border-gray-700">
                ...
                <div className="grid gap-3">
                  {groupedItems[selectedSection].map((item) => (
                    <div
                      key={item.id}
                      className={`flex items-center gap-3 p-4 rounded-lg transition-all ${item.packed
                    ...
                    >
                      <button
                        ...
                        className={`w-6 h-6 rounded border-2 flex items-center justify-center transition-all ${item.packed
